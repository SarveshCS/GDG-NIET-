...
export default function HeroSection8() {
  ...
  useEffect(() => {
    const updateWindowWidth = () => {
      setIsMobile(window.innerWidth <= 768); // Mobile screen width condition
    };
      ...
      {[
        {
          ...
          variant: isMobile ? {} : sectionVariants, // Disable animation on mobile
        },
        {
          ...
          variant: isMobile ? {} : sectionRightVariants, // Disable animation on mobile
        },
        {
        ...
        // Use motion.div for larger screens, use div for mobile
        !isMobile ? (
          <motion.div
            ref={section.ref}
