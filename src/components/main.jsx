  ...
  const slides = [
    {
      ...
      pattern: 'radial-gradient(circle at 30% 30%, rgba(255,255,255,0.1) 10%, transparent 50%)',
      description: 'Join a vibrant ecosystem of passionate developers pushing technological boundaries.'
    },
    {
      number: '2',
      title: 'Learn from',
      ...
      description: 'Dive into cutting-edge learning experiences with industry-leading experts.'
    },
    {
      number: '03',
      title: 'Work on',
      ...
      pattern: 'diagonal-gradient(rgba(255,255,255,0.08) 45deg, transparent 45deg)',
      description: 'Collaborate on innovative projects that solve real-world challenges.'
    },
    {
      number: '04',
      title: 'Connect with',
      ...
      pattern: 'radial-gradient(circle at 70% 70%, rgba(255,255,255,0.1) 10%, transparent 50%)',
      description: 'Build meaningful connections with experienced industry professionals.'
    }
  ];
      ...
      <div style={styles.navContainer}>
        {slides.map((_, index) => (
          <div 
            ...
            style={{
              ...styles.navDot,
              backgroundColor: activeCard === index ? 'white' : 'rgba(255,255,255,0.3)',
