      ...
      <div className="relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-8">
          ...
          <div className="group relative"
            ...
            <button className="w-full px-8 py-6 text-xl font-medium text-white bg-[#F4B400] rounded-2xl shadow-lg 
          ...
          <div className="group relative"
               ...
               onMouseLeave={() => setHoveredButton(null)}>
            <button className="w-full px-8 py-6 text-xl font-medium text-white bg-[#4285F4] rounded-2xl shadow-lg 
              transform transition-all duration-500 hover:scale-105 hover:shadow-2xl
              relative overflow-hidden group-hover:tracking-wider">
          ...
          <div className="group relative"
               ...
               onMouseLeave={() => setHoveredButton(null)}>
            <button className="w-full px-8 py-6 text-xl font-medium text-white bg-[#0F9D58] rounded-2xl shadow-lg 
              transform transition-all duration-500 hover:scale-105 hover:shadow-2xl
              relative overflow-hidden group-hover:tracking-wider">
